...
def page_home():
    ...
    <style>
    .hero-wrap {
      background: linear-gradient(145deg, #0a2e14 0%, #1B5E20 45%, #0d3b1a 100%);
    ...
    .hero-wrap::before {
      ...
      background: radial-gradient(ellipse 70% 60% at 80% 50%, rgba(76,175,80,.18) 0%, transparent 65%),
                  radial-gradient(ellipse 40% 40% at 20% 80%, rgba(25,118,210,.12) 0%, transparent 60%);
    }
    .hero-badge {
      display:inline-flex; align-items:center; gap:8px;
      background:rgba(76,175,80,.15); border:1px solid rgba(76,175,80,.35);
      border-radius:40px; padding:6px 18px;
      font-size:.75rem; font-weight:700; color:#81C784;
    ...
    .hero-title span {
      background: linear-gradient(135deg, #81C784, #A5D6A7, #4FC3F7);
      -webkit-background-clip:text; -webkit-text-fill-color:transparent;
    }
    .hero-sub {
    ...
    .btn-primary:hover { transform:translateY(-2px); box-shadow:0 8px 28px rgba(46,125,50,.5); }
    .btn-outline {
      display:inline-flex; align-items:center; gap:8px;
    ...
    .stat-label { font-size:.75rem; color:rgba(255,255,255,.45); margin-top:4px; letter-spacing:.05em; text-transform:uppercase; }
    .hero-visual {
    ...
    .leaf-card-title { font-family:'Poppins',sans-serif; font-weight:700; color:#fff; font-size:.9rem; }
    .ai-badge {
      background:rgba(25,118,210,.3); border:1px solid rgba(66,165,245,.4);
      border-radius:20px; padding:3px 10px;
      font-size:.65rem; font-weight:700; color:#90CAF9; letter-spacing:.06em;
    }
    ...
    .scan-line {
      ...
      background: linear-gradient(90deg, transparent, rgba(66,165,245,.8), transparent);
    ...
    .result-label { font-size:.72rem; color:rgba(255,255,255,.5); }
    .result-value { font-family:'Poppins',sans-serif; font-size:.85rem; font-weight:700; color:#81C784; }
    .conf-badge {
      background:rgba(76,175,80,.2); border:1px solid rgba(76,175,80,.3);
      border-radius:20px; padding:4px 12px;
      font-family:'Poppins',sans-serif; font-size:.8rem; font-weight:700; color:#A5D6A7;
    }
    </style>

    <div class="hero-wrap">
      <div style="position:relative; z-index:1; display:grid; grid-template-columns:1fr 1fr; gap:48px; align-items:center; max-width:1200px; margin:0 auto;">
        <div style="animation:fadeUp .5s ease both;">
          <div class="hero-badge">🌿 AI-Powered · Plant Pathology</div>
          <h1 class="hero-title">
            Detect Crop<br>Diseases with<br><span>AI Precision</span>
          </h1>
          <p class="hero-sub">
            Upload a leaf image and get instant disease analysis, severity scoring, and expert treatment recommendations — powered by deep learning.
          </p>
          <div class="hero-btns">
            <div class="hero-scan-btn" style="display:inline-block;">
              Start Disease Scan →
            </div>
            <div class="hero-learn-btn" style="display:inline-block;">
              ▶ How It Works
            </div>
          </div>
          <div class="hero-stats">
            ...
            <div class="stat-item" style="border-left:1px solid rgba(255,255,255,.1); padding-left:32px;">
        ...
        <div class="hero-visual" style="animation:fadeUp .65s ease both;">
          <div class="leaf-card">
            <div class="leaf-card-header">
              <span class="leaf-card-title">🔬 AI Scanning...</span>
            ...
            <div class="result-row">
              <div>
                ...
                <div class="result-value">Late Blight</div>
              </div>
              <div class="conf-badge">94.2%</div>
            </div>
          </div>
        </div>
      </div>
    ...
    with col2:
        if st.button("🔬  Start Disease Scan", key="hero_scan",
                     use_container_width=True):
            nav("scan")
    with col3:
        if st.button("📊  View Dashboard", key="hero_dash",
                     use_container_width=True):
            nav("dashboard")

    st.markdown("""<style>
    [data-testid="baseButton-secondary"]:nth-of-type(1) button,
    div[data-testid="column"]:nth-child(2) button {
      background: linear-gradient(135deg,#1E7D32,#1B5E20) !important;
      color: #fff !important;
      border: none !important;
      padding: 14px !important;
      font-size: .95rem !important;
      font-weight: 700 !important;
      box-shadow: 0 4px 20px rgba(30,125,50,.35) !important;
    }
    ...
    <div style="padding: 0 48px; max-width:1200px; margin:0 auto;">
      <div style="text-align:center; margin-bottom:40px; animation:fadeUp .5s ease both;">
        ...
        <h2 style="font-family:'Poppins',sans-serif; font-size:2rem; font-weight:800;
                   color:var(--text-1); letter-spacing:-.03em;">
          Everything You Need to<br>Protect Your Crops
        </h2>
      </div>
      <div style="display:grid; grid-template-columns:repeat(3,1fr); gap:24px; flex-wrap:wrap;">

        <div style="background:var(--surface); border:1px solid var(--border); border-radius:var(--radius);
                    padding:32px 28px; animation:fadeUp .5s .1s ease both; opacity:0;
                    animation-fill-mode:forwards; transition:transform .2s, box-shadow .2s;">
          <div style="width:52px;height:52px;background:linear-gradient(135deg,#E8F5E9,#C8E6C9);
                      border-radius:14px;display:flex;align-items:center;justify-content:center;
                      font-size:1.4rem;margin-bottom:20px;box-shadow:0 4px 12px rgba(76,175,80,.2);">📸</div>
          <h3 style="font-family:'Poppins',sans-serif;font-size:1.05rem;font-weight:700;
                     color:var(--text-1);margin-bottom:10px;">Instant Diagnosis</h3>
          <p style="font-size:.875rem;color:var(--text-3);line-height:1.7;">
            Upload any leaf photo and receive AI-powered disease identification within seconds.
            Works on 38+ disease categories across major crops.
          </p>
        ...
        <div style="background:linear-gradient(135deg,#1E7D32,#1B5E20); border-radius:var(--radius);
                    padding:32px 28px; animation:fadeUp .5s .2s ease both; opacity:0;
                    animation-fill-mode:forwards; box-shadow:var(--shadow);">
          <div style="width:52px;height:52px;background:rgba(255,255,255,.15);
                      border-radius:14px;display:flex;align-items:center;justify-content:center;
                      font-size:1.4rem;margin-bottom:20px;">💊</div>
          <h3 style="font-family:'Poppins',sans-serif;font-size:1.05rem;font-weight:700;
                     color:#fff;margin-bottom:10px;">Treatment Plans</h3>
          <p style="font-size:.875rem;color:rgba(255,255,255,.7);line-height:1.7;">
            Get targeted fungicide, pesticide, and cultural recommendations tailored to disease
            type and severity level — actionable guidance instantly.
          </p>
          <div style="margin-top:20px;display:flex;align-items:center;gap:6px;
                      font-size:.78rem;font-weight:600;color:#A5D6A7;">
            Learn more →
          </div>
        </div>

        <div style="background:var(--surface); border:1px solid var(--border); border-radius:var(--radius);
                    padding:32px 28px; animation:fadeUp .5s .3s ease both; opacity:0;
                    animation-fill-mode:forwards;">
          <div style="width:52px;height:52px;background:linear-gradient(135deg,#E3F2FD,#BBDEFB);
                      border-radius:14px;display:flex;align-items:center;justify-content:center;
                      font-size:1.4rem;margin-bottom:20px;box-shadow:0 4px 12px rgba(25,118,210,.15);">📈</div>
          <h3 style="font-family:'Poppins',sans-serif;font-size:1.05rem;font-weight:700;
                     color:var(--text-1);margin-bottom:10px;">History & Analytics</h3>
          <p style="font-size:.875rem;color:var(--text-3);line-height:1.7;">
            Track scans over time, monitor disease trends, and build a field-level health record
      ...
      <div style="max-width:900px; margin:0 auto;">
        <div style="text-align:center; margin-bottom:48px;">
          ...
          <h2 style="font-family:'Poppins',sans-serif;font-size:1.9rem;font-weight:800;
                     color:var(--text-1);letter-spacing:-.03em;">Three Steps to a Diagnosis</h2>
        </div>
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:32px;align-items:start;">
          <div style="text-align:center;">
            <div style="width:64px;height:64px;background:linear-gradient(135deg,#1E7D32,#2E7D32);
                        border-radius:50%;display:flex;align-items:center;justify-content:center;
                        font-size:1.6rem;margin:0 auto 16px;box-shadow:0 8px 24px rgba(30,125,50,.3);">📷</div>
            <div style="width:32px;height:32px;background:var(--green-700);border-radius:50%;
                        display:flex;align-items:center;justify-content:center;
                        font-family:'Poppins',sans-serif;font-size:.8rem;font-weight:800;color:#fff;
                        margin:0 auto 14px;">1</div>
            <h4 style="font-family:'Poppins',sans-serif;font-weight:700;color:var(--text-1);margin-bottom:8px;">Capture Leaf</h4>
            <p style="font-size:.84rem;color:var(--text-3);line-height:1.65;">
              Take a clear close-up photo of the affected leaf in natural daylight
            </p>
          </div>
          <div style="text-align:center;">
            <div style="width:64px;height:64px;background:linear-gradient(135deg,#1565C0,#1976D2);
                        border-radius:50%;display:flex;align-items:center;justify-content:center;
                        font-size:1.6rem;margin:0 auto 16px;box-shadow:0 8px 24px rgba(25,118,210,.3);">🤖</div>
            <div style="width:32px;height:32px;background:var(--blue-600);border-radius:50%;
                        display:flex;align-items:center;justify-content:center;
                        font-family:'Poppins',sans-serif;font-size:.8rem;font-weight:800;color:#fff;
                        margin:0 auto 14px;">2</div>
            <h4 style="font-family:'Poppins',sans-serif;font-weight:700;color:var(--text-1);margin-bottom:8px;">AI Analysis</h4>
            <p style="font-size:.84rem;color:var(--text-3);line-height:1.65;">
              Our MobileNetV2 model processes the image and identifies disease patterns
            </p>
          </div>
          <div style="text-align:center;">
            <div style="width:64px;height:64px;background:linear-gradient(135deg,#E65100,#F57C00);
                        border-radius:50%;display:flex;align-items:center;justify-content:center;
                        font-size:1.6rem;margin:0 auto 16px;box-shadow:0 8px 24px rgba(230,81,0,.3);">📋</div>
            <div style="width:32px;height:32px;background:#E65100;border-radius:50%;
                        display:flex;align-items:center;justify-content:center;
                        font-family:'Poppins',sans-serif;font-size:.8rem;font-weight:800;color:#fff;
                        margin:0 auto 14px;">3</div>
            <h4 style="font-family:'Poppins',sans-serif;font-weight:700;color:var(--text-1);margin-bottom:8px;">Get Report</h4>
            <p style="font-size:.84rem;color:var(--text-3);line-height:1.65;">
              Receive a detailed diagnosis with confidence score and treatment plan
            </p>
          </div>
        </div>
      </div>
